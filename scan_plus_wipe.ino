...
CRGB bgColor = CHSV(50,120,180);
CRGB scanColor = CHSV(200,240,80);
CRGB wipeColor = CHSV(50,200,90);
...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE, DATA_PIN, COLOR_ORDER>(leds, NUM_LEDS);// ***For strips using Clock.
