...
void sawtooth() {
  ...
  if (cur_led == 0)
   fill_solid(leds, NUM_LEDS, CRGB::YellowGreen);
  else
    leds[cur_led] = ColorFromPalette(currentPalette, 50, 100, currentBlending);    // I prefer to use palettes instead of CHSV or CRGB assignments.
