...
#include "FastLED.h"
#define LED_TYPE WS2812  // ***Update to your strip type.  NEOPIXEL, APA102, LPD8806, etc.
#define DATA_PIN 5  // ***Remember to set this to your data pin
#define NUM_LEDS 60  // ***Remember to set this to your strip length
